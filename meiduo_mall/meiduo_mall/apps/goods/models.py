...
class SPU(BaseModel):
    ...
    category1 = models.ForeignKey(GoodsCategory, related_name='cat1_spu', on_delete=models.PROTECT, verbose_name='一级类别')
    category2 = models.ForeignKey(GoodsCategory, related_name='cat2_spu', on_delete=models.PROTECT,
                                  verbose_name='二级类别')
    category3 = models.ForeignKey(GoodsCategory, related_name='cat3_spu', on_delete=models.PROTECT,
                                  verbose_name='三级类别')
    sales = models.IntegerField(default=0, verbose_name='销量')
    comments = models.IntegerField(default=0, verbose_name='评论量')
    desc_detail = models.CharField(max_length=100, default='', verbose_name='详细介绍')
    desc_pack = models.CharField(max_length=100, default='', verbose_name='包装信息')
    desc_service = models.CharField(max_length=100, default='', verbose_name='售后服务')
...
class SPUSpecification(BaseModel):
    """SPU规格"""
    spu = models.ForeignKey(SPU, related_name='specs', on_delete=models.CASCADE, verbose_name='spu')
